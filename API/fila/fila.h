 ...
 *
 * A estrutura node representa um nó da fila que armazena um dado e os ponteiros para o próximo nó e o nó anterior, sendo assim uma estrutura duplamente encadeada.
 *
 * \var node::data
